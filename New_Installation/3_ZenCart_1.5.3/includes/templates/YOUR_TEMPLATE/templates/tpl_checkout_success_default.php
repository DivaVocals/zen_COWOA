...
<?php if($COWOA) {?>
    <div id="order_steps">
            ...
            <span class="order_steps_text1_COWOA"><?php echo TEXT_ORDER_STEPS_BILLING; ?></span><span class="order_steps_text2_COWOA"><?php echo TEXT_ORDER_STEPS_1; ?></span><span class="order_steps_text3_COWOA"><?php echo TEXT_ORDER_STEPS_2; ?></span><span class="order_steps_text4_COWOA"><?php echo TEXT_ORDER_STEPS_3; ?></span><span id="active_step_text_COWOA"><i class="fa fa-shopping-cart"></i><br /><?php echo TEXT_ORDER_STEPS_4; ?></span>
            </div>
...
<?php } else {?>
    <div id="order_steps">
            <div class="order_steps_text">
            <span class="order_steps_text2"><?php echo TEXT_ORDER_STEPS_1; ?></span><span class="order_steps_text3"><?php echo TEXT_ORDER_STEPS_2; ?></span><span class="order_steps_text4"><?php echo TEXT_ORDER_STEPS_3; ?></span><span id="active_step_text"><i class="fa fa-shopping-cart"></i><br /><?php echo TEXT_ORDER_STEPS_4; ?></span>
            </div>
             <div class="order_steps_line_2">
